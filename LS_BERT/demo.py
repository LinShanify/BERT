...
from weights import BERT_Weight_Downloader

path = "data/"
weight_path = "weights"
bert_weight = "chinese_roberta_wwm_ext_pytorch"
BERT_Weight_Downloader(weight_path,bert_weight)
tokenizer = BertTokenizer(vocab_file=os.path.join(weight_path,bert_weight,"vocab.txt"))
